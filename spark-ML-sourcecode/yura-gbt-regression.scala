// This is Gradient-boosted tree regression model for Yura's Cutting&Crimping Process
// created 2020 03 21
// R2 = -2.20
...
val gbt = new GBTRegressor().setLabelCol(lable).setFeaturesCol("Features").setMaxIter(10).setMaxBins(500)
...
val importances = model.stages.last.asInstanceOf[GBTRegressionModel].featureImportances
...
val file = pmml.buildFile(new File("/Users/gary/Onedrive//gbtr.pmml"))